...
import RewardSelector from "@/components/admin/course/RewardSelector";
import ExamCreator from "@/components/admin/course/unit/lesson/ExamCreator";
...
export default function ItemEditModal({
  ...
  // Materials (Hỗ trợ cả Link và File Upload)
  ...
  useEffect(() => {
    if (data && isOpen) {
      ...
      // Load Materials (Giả sử DB lưu mảng string URL, ta map tạm thành object)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Chỉ lấy URL string để lưu xuống DB (nếu DB bạn lưu mảng string)
