    ...
    switch (item.rarity) {
      case "COMMON":
        return {
          ...
          imgFilter: "grayscale opacity-60 blur-[2px]", // Mờ rất nhẹ
          textBlur: "blur-[2px]",
      ...
      case "LEGENDARY":
        return {
          ...
          textBlur: "blur-[5px]",
          iconColor: "text-yellow-400", // Ổ khóa màu vàng để kích thích
        };
      default:
        return {
          bg: "bg-gray-50",
        ...
        <div className="flex-1 flex flex-col items-center justify-center w-full relative my-2 overflow-hidden">
          ...
          {!isOwned && (
            <div className="absolute inset-0 flex items-center justify-center z-20">
              {/* Thêm nền trắng mờ tròn sau ổ khóa để nó nổi bật trên nền ảnh */}
