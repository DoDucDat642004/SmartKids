...
import CourseEditModal from "@/components/admin/course/CourseEditModal";
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 p-4 md:p-8 font-sans w-full">
      <div className="w-full">
        ...
        {/* CONTENT GRID */}
        {/* Grid Responsive: Lên đến 4 cột ở màn hình lớn (xl) và 5 cột ở màn hình cực lớn (2xl) */}
        {courses.length > 0 ? (
          <motion.div
                  ...
                  >
                    ...
                    <div className="p-5 flex-1 flex flex-col">
                      <div className="mb-3">
                        ...
                        {/* SỬA LỖI: Tăng chiều cao h-10 (40px) và text-sm để hiển thị rõ 2 dòng */}
                      ...
                      <div className="mt-auto flex gap-2 pt-4 border-t border-slate-50">
                        <Link
                          href={`/admin/courses/${course._id}/structure`}
                          className="flex-1"
                        >
                          <motion.button
