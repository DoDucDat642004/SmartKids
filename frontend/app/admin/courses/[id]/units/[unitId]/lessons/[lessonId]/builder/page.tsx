...
export default function LessonBuilderPage() {
  ...
  // Dùng Object lessonData để chứa cả title, type, videoUrl...
  ...
  const handleResourceSelect = (item: any) => {
    ...
    // Nếu đang chọn Media cho field cụ thể
    if (
    ...
    <div className="min-h-screen bg-gray-50 pb-32">
      ...
      {settingModalOpen && lessonData && (
        <ItemEditModal
          ...
          onSave={() => {
            // Reload data sau khi sửa tên/ảnh nền
            courseService
              .getLesson(lessonId)
