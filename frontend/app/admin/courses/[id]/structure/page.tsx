...
import ItemEditModal from "@/components/admin/course/unit/ItemEditModal";
...
export default function CourseStructurePage() {
  ...
  const handleAddLesson = async (unitId: string) => {
    ...
    if (!title) return;
    try {
      // Mặc định tạo bài là GAME, người dùng có thể đổi sau trong Cấu hình
              ...
              {unit.lessons?.map((lesson: any) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition">
                    ...
                    {/* CHỈ HIỆN NÚT BUILDER NẾU LÀ GAME HOẶC EXAM */}
                    {(lesson.type === "GAME" ||
                      lesson.type === "EXAM" ||
                      !lesson.type) && (
                      <Link
                        href={`/admin/courses/${course._id}/units/${unit._id}/lessons/${lesson._id}/builder`}
